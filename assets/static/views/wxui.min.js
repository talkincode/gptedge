...
webix.protoUI({name:"webconsole",append:function(a){var b=this.config.template();b?this.setHTML(b+a):this.setHTML(a)},clear:function(){this.setHTML("")},defaults:{css:"web-console",borderless:!0,scroll:"y"}},webix.ui.template);webix.protoUI({name:"chatgptmsg",append:function(a){let b=this.config.template();b?this.setHTML(b+a):this.setHTML(a)},clear:function(){this.setHTML("")},defaults:{css:"chatgpt-message",borderless:!0,autoheight:!0}},webix.ui.template);
...
void 0!==a.scrollX&&(b.scrollX=a.scrollX);void 0!==a.editable?(b.editable=a.editable,b.editaction="dblclick"):b.editable=!1;b.rightSplit=void 0!==a.rightSplit?a.rightSplit:1;a.autoConfig?b.autoConfig=a.autoConfig:b.columns=a.columns;a.pager&&(b.pager=a.tableid+".dataPager");a.url&&(b.url=a.url);a.save&&(b.save=a.save);a.data&&(b.data=a.data);a.subview&&(b.subview=a.subview);b.on.onBeforeLoad=function(){this.showOverlay("\u52a0\u8f7d\u6570\u636e...")};b.on.onAfterLoad=function(){this.count()?this.hideOverlay():
